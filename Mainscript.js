<script>
        ...
        //localStorage.setItem("newuser", "999");
    var num;
    var door;
    ...
    * The result will likely be an unordered node iterator. */
    ...
    var alertText = "";
        ...
        e = e || window.event;
            ...
            // var z = localStoorage.getItem("Mainn");
            // alert(z);
            // alert(newuser);
        ...
        ding = snapshot.val();
                        ...
                        // alert(ding);
                        //   alert(num);
                        //localStorage.setItem("newuser23", ding);
        ...
        firebase.database().ref('User-' + door).child('Session-' + y).child(++sessionStorage.clickCount).set(
            ...
            /*var y = localStorage.getItem("newuser");
          firebase.database().ref(y).child(sessionStorage.clickCount).set(
              {Clicked: text });
              */
        ...
        alert(global);
                  ...
                  //  firebase.database().ref("User").set(
                        {name: document.getElementById("namefiled").value }
        //

           //     );

                    firebase.database().ref(global).set(
                        {king: document.getElementById("namefiled").value });
